...
STATIC_URL = '/static/'
STATICFILES_DIRS=[BASE_DIR/"static","login",]
LOGIN_URL = '/login/'
...
EMAIL_HOST_USER = 'nimmagantiharika@gmail.com'  # Your Gmail address
EMAIL_HOST_PASSWORD = 'Swaroop@1401'  # Your Gmail password or app-specific password
